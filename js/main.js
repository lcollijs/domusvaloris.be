    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                fetch('https://script.google.com/macros/s/AKfycbyRKERTChNhvxWWSD1D-i94Lx9qt-zBx1d-H7ThRqukQiSfyJeLY7EIaDV49DfLhek/exec', {
                    method: 'POST',
                ...
                .catch(() => {
                    alert('Er ging iets mis bij het versturen. Probeer het opnieuw, bel ons op +32 473 78 42 03 of mail naar info@domusvaloris.be.');
                })
                .finally(() => {
